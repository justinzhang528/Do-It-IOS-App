                        ...
                        Section(header: Text("Added Tasks")) {
                            ForEach(self.toDoLists, id: \.self) { number in
                                ForEach(self.toDoLists[self.toDoLists.firstIndex(of: number)!].tasks, id: \.self) { index in
                                    HStack{
                                        if(index.dueDate! > Date() || index.isRemind)
                                        {
                        ...
                        Group {
                            ...
                            HStack {
                                ...
                                Button(action:{
                                    ...
                                    if (self.newToDoTask != ""){
                                        self.toDoLists[2].tasks.append(Task(title: self.newToDoTask, createdAt: Date(), note: self.newNote, remindAt: Date(), dueDate: Date()))
